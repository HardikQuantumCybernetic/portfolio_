...
const HireMe = () => {
  const services = [
    { icon: Globe, title: "Website Development", description: "Custom responsive websites tailored to your needs" },
    { icon: Palette, title: "Advertisement Websites", description: "Eye-catching landing pages and promotional sites" },
    { icon: Database, title: "Database Integration", description: "Full database support for dynamic web applications" },
    { icon: Server, title: "Any Type of Website", description: "E-commerce, portfolios, blogs, dashboards, and more" },
  ];
        ...
        <div className="pt-24 pb-16">
          <div className="container mx-auto px-6">
              ...
              <InteractiveCard>
                <div className="relative p-8 rounded-2xl card-gradient border border-primary/50 glow-box">
                  ...
                  <div className="text-center pt-4">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Hosting charges are separate</p>
                  </div>
            ...
            <div className="text-center animate-fade-up delay-300">
              <p className="text-muted-foreground mb-6">Have questions? Check out my work first!</p>
              <Button variant="outline" className="gap-2 border-border hover:border-primary hover:text-primary" asChild>
                <Link to="/projects">
                  View My Projects
